...
<html lang="es">
    <head>
        ...
        <title>503 Página en Mantenimiento - FullGas</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="mb-4 img-error" src="{{ asset('img/logo/FINAL BANNER.jpg') }}" style="width: 320px" />
                                    <p class="lead">Atención de tickets: sistemas@fullgas.com.mx</p>
