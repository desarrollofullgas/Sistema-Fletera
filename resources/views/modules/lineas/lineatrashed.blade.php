<x-app-layout>
    @section('title', 'LDT Eliminados')
    <x-slot name="header">
        <div>
            <x-card-greet-header>
                {{ __('Lineas de Transporte Eliminados') }}
            </x-card-greet-header>
        </div>
    </x-slot>
    <div class="content">
                                    ...
                                    @foreach ($trashed as $ldt)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <div class="text-sm">
                                                    <div class="font-medium text-gray-700 uppercase">{{ $ldt->name }}</div>
                                                </div>
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="grid grid-cols-2">
                                                    <div>
                                                        ...
                                                        <form method="POST" action="{{ route('linea_restore') }}"
                                                            onsubmit="return confirm('Restaurar LDT');">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id"
                                                                value="{{ $ldt->id }}" required />
                                                            <button type="submit">
