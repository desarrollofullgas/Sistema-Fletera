<x-app-layout>
    ...
    <div class="p-6 flex flex-col gap-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <fieldset class="border dark:border-gray-500 p-2 rounded-md">
            <legend class="text-xl px-2 bg-dark-eval-0 text-gray-200 rounded-md">Información de la recepción</legend>
    ...
    <br>
    @livewire('recepcion.editar-recepcion',['viajeID'=>$viaje->id])
</x-app-layout>