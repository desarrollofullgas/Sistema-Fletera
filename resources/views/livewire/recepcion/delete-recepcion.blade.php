<x-modal-create tipo="edit" class="w-full">
    ...
    <x-slot name="content">
        <div class="flex flex-col gap-2 justify-center">
            ...
            <span class="text-center dark:text-white">¿Está seguro de eliminar el la recepción de pipa del carta porte #<i>"{{$recepcion->cataporte->id}}"</i> ?</span>
        </div>
    </x-slot>
    <x-slot name="btn_action">
        <x-danger-button class="mr-2" wire:click="deleteRecepcion" wire:loading.attr="disabled">
            <div role="status" wire:loading wire:target="deleteRecepcion">
                <x-icons.spin/>
                <span class="sr-only">Eliminando datos...</span>
            </div>
            Aceptar
        </x-danger-button>
