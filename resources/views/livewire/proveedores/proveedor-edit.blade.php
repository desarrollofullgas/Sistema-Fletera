<div>
    ...
    <x-dialog-modal wire:model="EditProv" id="EditProv{{ $prov_id }}" class="flex items-center">
        <x-slot name="title">
        ...
        <x-slot name="content">
            <div class="flex flex-wrap">
                ...
                <div class="mb-3 mr-2 col-6" wire:ignore>
                    ...
                    <x-input wire:model="razon_social" class="{{ $errors->has('razon_social') ? 'is-invalid' : '' }}" type="text"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="mb-3 mr-2 col-6" wire:ignore>
                    ...
                    <x-input wire:model="direccion" class="{{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text"
        ...
        <x-slot name="footer" class="d-none">
            <x-danger-button class="mr-2" wire:click="EditarProveedor({{ $prov_id }})" wire:loading.attr="disabled">
                <div role="status" wire:loading wire:target="EditarProveedor">
            ...
            <x-secondary-button wire:click="$toggle('EditProv')" wire:loading.attr="disabled">
                Cancelar
            </x-secondary-button>
        </x-slot>
    </x-dialog-modal>
