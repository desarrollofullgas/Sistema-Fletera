<x-modal-create tipo="edit">
    ...
    <x-slot name="content">
        <div class="flex flex-col gap-2 justify-center">
            ...
            <span class="text-center dark:text-white">¿Está seguro de eliminar a <i>"{{$name}}"</i> ?</span>
        </div>
    </x-slot>
    <x-slot name="btn_action">
        <x-danger-button class="mr-2" wire:click="deleteUnidad" wire:loading.attr="disabled">
            <div role="status" wire:loading wire:target="deleteUnidad">
