<x-modal-create button_tittle="Reporte de existencias" tittle="Reporte de existencias" tipo="">
    <x-slot name="content">
        <div x-data="{ind:false}">
            <div class="flex justify-center gap-2">
                <div>
                    <input type="radio" id="generalEx" name="tipoEx" value="general"  wire:model.defer='tipo' class="peer/exgral hidden">
                    <label for="generalEx" class="px-2 py-1 rounded-full cursor-pointer bg-gray-400 text-gray-200 dark:bg-dark-eval-0 peer-checked/exgral:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-700" @click="ind=false">
                        General
                    </label>
                </div>
                <div>
                    <input type="radio" id="onlyEX" name="tipoEx" value="only"  wire:model.defer='tipo' class="peer/exInd hidden">
                    <label for="onlyEX" class="px-2 py-1 rounded-full cursor-pointer bg-gray-400 text-gray-200 dark:bg-dark-eval-0 peer-checked/exInd:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-700" @click="ind=true">
                        Individual
                    </label>
                </div>
            </div>
