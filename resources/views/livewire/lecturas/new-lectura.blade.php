                            ...
                            <div >
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select id="combustible" x-model="detalle.tipo"
                                            ...
                                            <template x-for="tipoCombustible in selectCombustible">
                                                <option x-bind:value="tipoCombustible.id" x-text="tipoCombustible.tipo">
                                                </option>
                                            </template>
                                        </select>
                                    </div>
                                ...
                                <div class="flex flex-wrap justify-evenly gap-2 py-2 border-b dark:border-gray-500">
                                    <div class="max-sm:w-full">
                                        ...
                                        <x-input x-model="detalle.velectronica" @input="calculateTotalLitros()"
                                            type="text" name="velectronica" id="velectronica" required
                                            autocomplete="velectronica" class="max-sm:w-full" />
                                        <x-input-error for="velectronica"></x-input-error>
                                    </div>
                                    <div class="max-sm:w-full">
                                        <x-label value="{{ __('Venta Odómetro') }}" for="vodometro" />
                                        <x-input x-model="detalle.vodometro" type="text" name="vodometro"
                                            id="vodometro" required autocomplete="vodometro" class="max-sm:w-full" />
                                    ...
                                    <div class="max-sm:w-full">
                                        ...
                                        <x-input x-model="detalle.vperiferico" type="text" name="vperiferico"
                                            id="vperiferico" required autocomplete="vperiferico"
                                            class="max-sm:w-full" />
            ...
            <div class="w-full">
                <div class="flex flex-wrap justify-evenly gap-2 mb-2">
                    <div class="max-sm:w-full">
                        ...
                        <x-input x-model="tlitros" wire:model.defer="tlitros" type="number" :name="'tlitros'"
                            :id="'tlitros'" readonly class="w-full" />
